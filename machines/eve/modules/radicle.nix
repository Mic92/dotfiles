...
}:
{
  ...
  # GitHub Actions sync endpoint
  # Usage: ssh radicle-sync@radicle.thalheim.io
  # Each repo gets a dedicated deploy key generated by clan vars
  #
  # To add a new repo:
  #   1. Add entry below
  #   2. Run: clan vars generate
  #   3. Run: gh-radicle (in the repo) to set up GitHub
  services.radicle.githubSync = {
    enable = true;
    repos = [
      # (mkRepo {
      #   name = "Mic92-dotfiles";
      #   repoId = "z2dqRKkK5yu89w3CMX2dVsYrRwvFk";
      #   githubUrl = "https://github.com/Mic92/dotfiles";
      # })
      # (mkRepo {
      #   name = "Mic92-nix-fast-build";
      #   repoId = "z3i92bZDrPYnftcX7rnVLxPgFJPdQ";
      #   githubUrl = "https://github.com/Mic92/nix-fast-build";
      # })
    ];
  };

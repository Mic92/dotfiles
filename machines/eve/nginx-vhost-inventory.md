...
| `torrent.thalheim.io`       | nixosModules/rqbit.nix                         |
...
| `warez.r`                   | nixosModules/rqbit.nix                         |
...
| `torrent.thalheim.io`                                 | rqbit web UI/API proxied to `http://127.0.0.1:3030`, guarded by Authelia (`/authelia` internal verify, `error_page 401` redirect).                 | Needs Authelia forward-auth replication.                                                                                                                                                                     |
...
| `warez.r`                                                         | `/var/lib/rqbit/downloads` with `fancyindex` enabled.   | Enable directory listing equivalents in Caddy (`file_server browse`).                                                                                                                                                                                                                                      |

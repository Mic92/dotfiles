...
| `torrent.thalheim.io`       | nixosModules/rqbit                             |
...
| `warez.thalheim.io`         | nixosModules/rqbit                             |
...
| `warez.thalheim.io`                                               | Static media webapp + `/files/` JSON autoindex over `/var/lib/rqbit/downloads`, Authelia protected. |                                                                                                                                                                                                                                                                                                            |

...

{
  ...
  services.ssh3 = {
    ...
    urlPath = lib.mkDefault "ssh3-${
      builtins.substring 0 16 (builtins.hashString "sha256" "eva-ssh3-secret")
    }";
  };

  # Nginx reverse proxy configuration for HTTP/3 access
  services.nginx.virtualHosts."ssh3-eva.thalheim.io" = {
    forceSSL = true;
    enableACME = true;

...
in
{
  services.home-assistant.config = {
    conversation.intents = {
      FindIphone = [ "find [(Shannan's|Shannon's)] (phone|IPhone)" ];
      FindWatch = [ "find [(Shannan's|Shannon's)] (watch|Apple Watch)" ];
      FindMacbook = [ "find [(Shannan's|Shannon's)] (laptop|Macbook)" ];
    };
    intent_script = {

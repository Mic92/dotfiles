 { ... }: {
   services.home-assistant.config = {
     ...
     automation = [{
       ...
       condition = {
         condition = "template";
         value_template = ''{{ ("rain" in states.sensor.dark_sky_icon.state or "snow" in states.sensor.dark_sky_icon.state) and states.input_boolean.rain_notified_today.state != "on" and (states("sensor.dark_sky_precip_probability_0h") | float) >= 60}}'';
       };
     } {

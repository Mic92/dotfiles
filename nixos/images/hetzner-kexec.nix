...
# rescue> tar -C / -xf nixos-system-x86_64-linux.tar.xz
# rescue> /kexec_nixos
# rescue> zpool import zroot
# rescue> zfs load-key -a
# rescue> mount -t zfs zroot/root/nixos /mnt; mount /dev/sda2 /mnt/boot/; mount -t zfs zroot/root/home /mnt/home/; mount -t zfs zroot/root/tmp /mnt/tmp/
# rescue> nixos-enter # will mount

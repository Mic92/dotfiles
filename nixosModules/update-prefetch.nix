...
}:
{
  ...
  systemd.services.update-prefetch = {
    ...
    script = ''
      ...
      store_path="$(curl -L https://nixbot.thalheim.io/nix-outputs/Mic92/dotfiles/main/${pkgs.stdenv.hostPlatform.system}.nixos-${config.networking.hostName})"
      ...
      if [[ -f /home/joerg/.homesick/repos/dotfiles/flake.nix ]]; then
        ...
        store_path="$(curl -L https://nixbot.thalheim.io/nix-outputs/Mic92/dotfiles/main/${pkgs.stdenv.hostPlatform.system}.home-manager-$profile)"
